...
in \siref{supp_param_inference} Peccoud \& Ycart derived a closed-form solution
...
of the Lagrangian with respect to $P_X(x)$, we chose a particular value of $X =
x$. Therefore from the sum over all possible $x$ values only a single term
survives. With this in mind we take the derivative of the Lagrangian obtaining
\begin{equation}
