...
\title{\textbf{Review for: First-principles prediction of the information
...
\addtocontents{toc}{\protect\setcounter{tocdepth}{-1}}
	...
	% supplemental references
		...
		\input{nat_comm_rev_01.tex}
		% \input{rev_jane_kondev.tex}
		% \input{rev_gasper_tkacik.tex}
		% \input{rev_alvaro_sanchez.tex}
		% \input{rev_sarah_marzen.tex}
		% \input{rev_rachel_taubman.tex}
