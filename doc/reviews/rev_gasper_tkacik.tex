...
We don't exactly understand the point about exploring the lower dimensional
...
basically given the same result. This is because most of the values of the
Kullback-Leibler divergence are significantly smaller than 0.1 bits, and the
entropy of these distributions is in general $> 10$ bits, so we would loose less
than 1\% of information by utilizing only two moments as constraints. Therefore
the use of non-Gaussian noise is not an important feature for our inferences.
