...
\begin{figure}[h!]
  ...
  {./fig/main/fig3_cell_cycle_moments.pdf}
	...
	affinities and different repressor copy numbers per cell. Dotted lines
	indicate linear scale while solid lines indicate logarithmic scale. White dots
	on the lower row are plotted on a different scale for visual clarity.}
