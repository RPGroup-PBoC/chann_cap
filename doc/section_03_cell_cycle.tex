...
applying an averaging like the one in \eref{eq_time_avg} for the span of a cell
...
\siref{supp_multi_gene} for comparison when this variability is not included).
...
\begin{figure}[h!]
  ...
  {./fig/main/fig3_cell_cycle_moments.pdf}
	...
	reporter construct was integrated. (B) mean mRNA (upper panel) and mean
	...
	each panel). Dotted lines indicate linear scale while solid lines indicate
