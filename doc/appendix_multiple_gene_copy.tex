...
reaching steady state of the mean mRNA count after the cell divides. This is
...
Fig. 18 of \cite{Phillips2019}), suggesting that these dynamical steady state
takes place \textit{in vivo}.
...
As mentioned in \siref{supp_param_inference}, cells in log phase have
