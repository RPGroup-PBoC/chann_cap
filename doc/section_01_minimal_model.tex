...
minimal model and the necessary set of parameters needed to predict the full
...
\begin{figure}[h!]
  ...
  {./fig/main/fig2_parameter_inference.pdf}
	...
	used to determine $\kroff$ and $\kron$, Brewster et al. \cite{Brewster2014}
	is used to determine $\eAI$ and $\kron$, Razo-Mejia et al.
	\cite{Razo-Mejia2018} is used to determine $K_A$, $K_I$, and $\kron$ and
	Jones et al. is used to determine $r_m$, $\kpon$, and $\kpoff$.}
