...
\cite{Peccoud1995} (no state $R$ from \fref{fig2_minimal_model}(A)) to mRNA FISH
...
\mrm{Given the separation of time-scales between the rapid conformational
changes of the repressor and the slower downstream processes} \rp{You'll have to
prove this }, we assume that the probability of the repressor being in the
...
in \fref{fig2_minimal_model}(A) cast in the language of rates is of the same
