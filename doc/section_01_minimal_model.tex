...
fraction of repressors in the active state. \mrm{Given the separation of
time-scales between the rapid conformational changes of the repressor and the
slower downstream processes} \rp{You'll have to prove this }, we assume that the
