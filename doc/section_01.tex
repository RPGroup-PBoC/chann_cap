...
\begin{figure}[h!]
	\centering \includegraphics[scale=1]{ratesDiagram} 
	\caption{\captionStroke{Rates diagram for simple repression.} The Lac repressor (red) competes with RNAP (light blue) for the promoter. Only when the latter is bound is mRNA produced, which is then translated into protein. Both mRNA and protein are degraded.}
