...
Brewster2014, Razo-Mejia2018} \mrm{Too self referential so far. Include Ido,
maybe Al Sanchez. It must be experiment-theory contrasting though!}. These
...
(output $p$) (\eref{eq_mutual_info}) we must compute the input-output function
...
as \eref{eq_mutual_info} maximized over all possible input distributions $P(c)$.
...
predictions of this non-trivial quantity. \mrm{Aztec pyramid reference}
...
\begin{figure}[h!]
  ...
  {./fig/main/intro_v02.pdf}
	...
	phenotypic response (right panel).}
  \label{fig1_intro}
\end{figure}
