...
depicted in \fref{fig1_intro}(A) for a bacterial cell sensing a chemical
...
\begin{figure}[h!]
  ...
  {./fig/main/intro_v02.pdf}
	...
	respond to external stimuli we imagine they perform a Bayesian inference of
	the state of the environment. As the phenotype (protein level) serves as the
	internal representation of the environmental state (inducer concentration),
	the probability of a cell being on a specific environment is a function of the
