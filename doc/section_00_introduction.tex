...
in \fref{fig1_intro}(B). The question then becomes this: how can one analyze
...
detailed models with precision measurements. In this work we approach this task
with a simple system tractable both theoretically and experimentally in which
