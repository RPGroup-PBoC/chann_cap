...
mechanisms, the field still lacks a rigorous experimental test of these ideas
with precision measurements on a simple system tractable both theoretically and
experimentally.
...
distinguish different inputs. This is analogous to how for an imaging system
the point spread function limits the ability to resolve two light emitting
point sources.
...
systematic deviation. Although the model does not completely succeed in
quantitatively predicting features of the input-output function, including the
channel capacity, we argue that this is an important contribution towards the
goal of having a foundational understanding of the physics of bacteria cell
decision-making.
