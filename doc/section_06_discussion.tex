...
distributions as shown in \siref{supp_maxent}. The agreement between our
...
binding energy (See \fref{fig5_channcap}). We note that this differs from
...
site (See \fref{fig3_cell_cycle}(B)). This systematic deviation for weak
binding sites remains an unresolved problem that deserves further
investigation. Also the minimal model in \fref{fig2_minimal_model}(A), despite
