...
capacity.
\rp{If I were a reviewer, I would be wondering about why to accept this as a 
helpful contribution? Is there a way to tighten up our discussion of
implications?}
...
energy (See \fref{fig5_channcap}). We note that this differs from previous
...
\fref{fig3_cell_cycle}(B)). Furthermore the
minimal model in \fref{fig2_minimal_model}(A), despite being widely used, is an
