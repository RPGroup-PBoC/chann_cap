...
$\rho \ll 1$. This approximation has been previously called the weak promoter
approximation \cite{Garcia2011c}. Given this we can simplify
...
parameters: $\kpon = 0.017_{-0.001}^{+0.002} s^{-1}$, $\kpoff = {0.24}_
{-0.11}^{+0.46} s^{-1}$, and $r_m = 0.5_{-0.2}^{+0.8} s^{-1}$. \mrm{again need
...
confirm that using the cell area as a proxy for stage in the cell cycle is a
good approximation.
