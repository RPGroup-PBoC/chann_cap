...
the probability of sampling a cell on a stage of the cell cycle $< f$ where the
reporter gene hasn't been replicated yet.
...
parameters: $\kpon = {0.03}_{-0.003}^{+0.005} s^{-1}$, $\kpoff = {0.6}
_{-0.2}^{+2.4} s^{-1}$, and $r_m = {1}_{-0.4}^{+3} s^{-1}$. \mrm{again
need to compare with what is known about these rates.}.
