...
\begin{equation}
  \begin{aligned}
    ...
    - \overbrace{\kron P_I(m, p)}^{E \rightarrow R}\\ % E -> R
...
for the \textit{lacUV5} promoter used throughout this work. This promoter being
...
\cite{Jones2014a}. With this in hand we can rewrite \eref{seq_fold_change_cme}
as
\begin{equation}
