...
# =============================================================================
# Read data
df_im = pd.read_csv('./outdir/' + str(DATE) + '_raw_segmentation.csv')
...
for c in fold_change_inducer:
    ...
    df_group = df_filt[(df_filt.rbs != 'auto') &\
                       (df_filt.rbs != 'delta')].groupby('rbs')
