...
# this buffer.
# 
# The files were saved on a hybrid format where some concentrations are in
# stacks and others are on independend folders. That was an accident since the
# computer turned off in the middle of the experiment.
# 
# ## Analysis files
# 
