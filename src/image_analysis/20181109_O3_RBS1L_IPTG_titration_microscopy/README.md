...
The cells for the ∆lacI grown at 5000 µM were slightly out of focus when the
images were taken. The autofocuse was adjusted afterwards, so a slight offshift
on this sample should not be taken seriously.

It was hard to find cells for the Autofluorescence strain grown at 
0 mM IPTG, so this particular set will have few entries.
