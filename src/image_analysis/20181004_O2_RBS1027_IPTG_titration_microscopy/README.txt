...
# 
# ## Notes & Observations
# Nothing particular about this data set other than again just like on
# 20181003 the files were not saved as ome.tiff, therfore the processing
# file manages the files differently
# 
# ## Analysis files
# 
